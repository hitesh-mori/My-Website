...
export const projects = [
  {
    id: "blinklock",
    title: "BlinkLock",
    shortDescription: "Intelligent Eye Detection & Screen Lock App that protects your privacy and sleep using advanced computer vision.",
    description: `## About

BlinkLock is an intelligent mobile application that uses advanced eye detection and face recognition to protect your sleep, enhance your study sessions, and provide smart screen management. The app automatically locks your phone or triggers alerts based on eye closure and face detection.

## Key Features

- **Sleep Mode**: Protects your sleep by locking the screen when eyes are closed or face is not detected.
- **Study Mode**: Helps you stay alert with smart alarms when you start dozing off.
- **Activity Log**: Tracks screen time and lock events.
...
- **Architecture**: MVVM`,
    ...
    tags: ["Flutter", "Android", "ML Kit", "Computer Vision", "Health"],
    category: "Mobile App",
...
- **Expense Management:** Developer creates expense â†’ Manager approves â†’ Admin approves â†’ Budget passed
...
export const products = [
  {
    ...
    slug: "blinklock",
    name: "BlinkLock",
    tagline: "Intelligent Eye Detection & Screen Lock",
    description: `## About
...
### Sleep Mode
Protects your sleep when you accidentally leave your phone on. If you fall asleep while using your phone, BlinkLock detects:
- **Face not detected**: Automatically locks the phone
- **Eyes closed**: Locks the device to prevent accidental touches
- Ensures uninterrupted sleep without screen light disturbance

### Study Mode
Helps you stay alert during study sessions. If you start dozing off while reading:
- **Eye closure detection**: Monitors for extended eye closure
- **Smart alarms**: Plays an alarm after a set duration to wake you up
- **Customizable duration**: Set your preferred detection interval
- Prevents wasted study time due to unintentional sleeping

### Custom Mode
Create your own personalized rules with multiple triggers and actions:
...
Mix and match triggers and actions to create rules that fit your lifestyle perfectly.

## Key Features

- **Real-time Eye Detection**: Advanced camera-based eye tracking
- **Face Recognition**: Detects when face is not visible
- **Touch Detection**: Monitors screen interaction patterns
- **Flexible Rules**: Fully customizable trigger-action combinations
...
- **Frontend**: Flutter, Dart
- **Backend**: Android Native (Kotlin)
- **Computer Vision**: ML Kit for face and eye detection
- **Services**: Accessibility Service, Foreground Service, Camera Service
- **Storage**: SharedPreferences
        
## Note
Please see the user guide for detailed information about data protection, application usage, and privacy policies. This application prioritizes your privacy and processes all data locally on your device.`,
    image: "https://firebasestorage.googleapis.com/v0/b/mori-hitesh.appspot.com/o/blinklock-coverimage.png?alt=media&token=04bead56-048f-4ca9-bfa9-f3c1353e69f1",
    icon: "ðŸ‘ï¸",
    ...
    links: {
      ...
      userGuide: "/blog/blinklock-user-guide",
    },
    stats: {
      users: "Beta Testing",
      rating: "N/A",
